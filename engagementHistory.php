...
<?php
        ...
        $sqlproducts = "SELECT * FROM orders WHERE customer='{$_SESSION['username']}' AND company='{$_GET['company']}' AND orderStatus = 0 ORDER BY Date DESC";
        ...
        if($res==true){
            while($rows = $res->fetch_assoc()){ 
             ...
             <td style="text-align:center;"><a href="orders.php?company=<?php echo $rows['company'];?> && username =<?php echo $_SESSION['username'];?>" style="text-decoration: none; color navy; text-align:center;">ORDER</a></td>
            </tr>

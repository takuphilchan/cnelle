...
<html>
    ...
    <?php
                include ('connect.php'); 
                session_start(); 
                 $sql = "SELECT t1.Date, t1.message, t1.SendBy, t1.Reciever, t2.username, t2.CustomerImage FROM review as t1 , customers as t2 WHERE (t1.SendBy='{$_SESSION['username']}' or t1.Reciever ='{$_SESSION['username']}')  and (t1.SendBy=t2.username) ORDER BY t1.Date ASC";

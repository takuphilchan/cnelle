            ...
            if(filter_var($email,FILTER_VALIDATE_EMAIL)){
                ...
                if($user==true){
                    if(mysqli_num_rows($user)==0){
                        $reg = "INSERT INTO customers (CustomerImage,username, FirstName,LastName,email,password,Phone,Country,Province) values ('$imgContent','$username','$firstname','$lastName','$email', '$hash','$phone','$country','$province')";
...
<div id="register">
<div class="form-top"> <strong class="form-name">Create Buyer Account</strong> </div>
<div><br>
<div class="form-body">
        <form action="register.php" method="POST" enctype="multipart/form-data">
             <h2 class="select-photo-label">Select profile picture</h2><br>
              <input type="file" id="file" name="image" style="display: none;" onchange="loadFile(event)">
              <label for="file"><div id="imgplace" style="background-image: url('images/placeholder.jpg');" class="signup-placeholder"></div></label>
              <br> 
              <div class="form">
            ...
            <div class="form">
              ...
              <div style="display: inline-flex;"><input type="checkbox" checked="checked" style="width:30px; height: 30px;"required/>
                <a href="information.php">&nbsp I accept the terms and conditions</a>
                </div><br><br> <br>
      
        <button type="submit" name="submit" class="button-for-forms">SIGN UP</button><br><br>
          </form><br>
          <div class="form-have-account">Already have an account?<a href="login.php" class="already">click here to Login</a></div><br><br>
</div></div></div>
</body>
</html>

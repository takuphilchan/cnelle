                            ...
                            if ($result->num_rows > 0) {     
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    if(($row["SendBy"]) == ($_SESSION["username"])){
                                        echo "<div class='message-container-me' >"."<div class='msg-com-me-img'>"."<div class='msg-com-me'>"."<p class='date-message-me'>".$row["Date"]."</p>".$row["message"]."</div>"."<br>"."<img src='".$imageURL."' alt='';  class='msg-images'  draggable='false'/>"."<br>"."</div>"."<img src='".$imgCustomer."' alt=''; class='sendby-me' draggable='false'/>"."</div>";
                                    }else{
                                        echo "<div class='message-container-sender'>"."<img src='".$imgOwner."' alt=''; class='sendby-someone' draggable='false'/>"."<div class='msg-com-img'>"."<div class='msg-com'>"."<p class='date-message-img-someone'>".$row["Date"]."</p>".$row["message"]."</div>"."<img src='".$imageURL."' alt='';  class='msg-images'  draggable='false'/>"."<br>"."</div>"."</div>"."<br>";
                                    }
